        ...
        <div class="container">
           ...
           <diV class="collapse navbar-collapse" id="Navbar">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="./product"><span class="fa fa-list fa-lg"></span>Product</a></li>
...
?>
        ...
        <div class="row row-content justify-content-center">
            <div class="col-12 col-sm-8">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                     <?php  
                     $resul = mysqli_query($conn,"SELECT * FROM product where (product.$productoption = '$zonesearch')");
                     while($row = mysqli_fetch_array($resul))
                            {
                                echo "<tr>";  
                                echo "<th>" . $row['codeproduct'] . "</th>";
                                echo "<th>" . $row['name'] . "</th>";
                                echo "<th>" . $row['partnumber'] . "</th>";
                                echo "</tr>";
                            }
                            mysqli_close($conn);
                            ?>
            ...
            <br><br>
            <form action="../models/searchproduct.php" method="POST">
                    <label for="product"><b>Select Product option :</b></label>
                    <select name='product' class="custom-select">
                        <option value="name">Product Name</option>
                        <option value="partnumber">Parts Number</option>
                    </select>
                    <br>
                    <br>
                    <br>
