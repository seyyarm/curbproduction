            ...
            <div class="col-12 col-sm-8">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                     ...
                     $res = mysqli_query($conn,"SELECT * FROM client where (client.$clientoption = '$zonesearch')");
...
<br>
                <form action="../models/searchclient.php" method="POST">
                    ...
                    <select name='client' class="custom-select">
                        ...
                        <option value="nameclient"client>Client Name</option>
